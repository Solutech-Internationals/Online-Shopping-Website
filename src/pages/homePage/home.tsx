...
function HomePage(){
    return(
        <>
            ...
            <div className="absolute bg-white top-full h-full w-full">

                {/*--------Trending Categories  Section---------*/}
                <div>
                    <h1 className="font-darker-grotesque text-[37px] font-semibold leading-[50.17px] text-left mt-20 ml-32 ">
                        Trending Categories
                    </h1>
                ...
                <div id="summerSaleSection" className="absolute bg-[#A65858] h-[350px] w-[100%]  top-[700px]   max-[1371px]:top-[1000px] max-[920px]:top-[1300px] max-[693px]:top-[1985px] ">
                    ...
                    <div className="relative max-[649px]:mt-[14rem]">
                        ...
                        <div>
                            {/*-------Electronic Items--------*/}
                            <div>
                                <h1 className="font-darker-grotesque text-[37px] font-[600] leading-[50.17px] text-left mt-[4rem] ml-32">
                                    Electronic Items
                                </h1>
                                <div className="flex flex-col items-center bg-white min-h-screen w-full  pb-20">
                                    <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 ml-[8.3rem] mr-[8.3rem]">
                            ...
                            <div className="absolute top-[560px] w-full max-[1371px]:top-[900px]  max-[919.200px]:top-[1200px]">
                                <h1 className="font-darker-grotesque text-[37px] font-[600] leading-[50.17px] text-left ml-32">
                                    Furniture Items
                                </h1>
                                <div className="flex flex-col items-center bg-white min-h-screen w-full pb-20">
                                    <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 ml-[8.3rem] mr-[8.3rem]">
